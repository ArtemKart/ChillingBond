...
async def test_verify_case_sensitive(hasher: BcryptPasswordHasher) -> None:
    ...
    assert hasher.verify("casesensitive", hashed) is False
    assert hasher.verify("CASESENSITIVE", hashed) is False
    assert hasher.verify("CaseSensitive", hashed) is True
...
async def test_verify_whitespace_sensitive(hasher: BcryptPasswordHasher) -> None:
    ...
    assert hasher.verify("passwordwithspaces", hashed) is False
    assert hasher.verify("password  with  spaces", hashed) is False
    assert hasher.verify("password with spaces", hashed) is True
...
async def test_hash_and_verify_workflow(hasher: BcryptPasswordHasher) -> None:
    ...
    for password in passwords:
        ...
        assert hasher.verify(password, hashed) is True
        assert hasher.verify(password + "wrong", hashed) is False
...
async def test_hash_consistency_with_direct_bcrypt(
    ...
    assert hasher.verify(password, direct_hash)
