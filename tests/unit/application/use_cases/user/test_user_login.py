...
async def test_success_returns_token(
    ...
    mock_user_repo.get_user_by_email.return_value = user_entity_mock
    ...
    mock_user_repo.get_user_by_email.assert_called_once_with(sample_form_data.username)
...
async def test_with_different_credentials(
    ...
    assert result.token == sample_token.token
    mock_user_repo.get_user_by_email.assert_called_once_with(form_data.username)
    user_entity_mock.verify_password.assert_called_once_with(
