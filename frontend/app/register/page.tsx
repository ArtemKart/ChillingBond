  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        // Человекочитаемые сообщения для известных статусов
        const friendlyMessages: Record<number, string> = {
          409: errorMessage, // "User already exists" с бэкенда
        ...
        throw new Error(friendlyMessages[response.status] || errorMessage);
      }
