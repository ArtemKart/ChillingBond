  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.detail || 'Не удалось добавить облигацию');
      }
      ...
      setError(err instanceof Error ? err.message : 'Ошибка добавления облигации');
    } finally {
      setIsSaving(false);
    }
  };
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Серия облигации <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Дата покупки <span className="text-red-500">*</span>
                </label>
                <input
                  type="date"
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Номинальная стоимость (₽) <span className="text-red-500">*</span>
                </label>
                <input
                  type="number"
                  step="0.01"
                  ...
                  onChange={(e) => handleChange('nominal_value', parseFloat(e.target.value) || 0)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900"                />
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Начальная процентная ставка (%) <span className="text-red-500">*</span>
                </label>
                <input
                  type="number"
                  step="0.01"
                  ...
                  onChange={(e) => handleChange('initial_interest_rate', parseFloat(e.target.value) || 0)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900"                />
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Маржа к ставке (%) <span className="text-red-500">*</span>
                </label>
                <input
                  type="number"
                  step="0.01"
                  value={formData.reference_rate_margin}
                  onChange={(e) => handleChange('reference_rate_margin', parseFloat(e.target.value) || 0)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900"                />
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Первый процентный период (мес) <span className="text-red-500">*</span>
                </label>
                <input
                  type="number"
                  min="1"
                  value={formData.first_interest_period}
                  onChange={(e) => handleChange('first_interest_period', parseInt(e.target.value) || 1)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900"                />
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Срок погашения (мес) <span className="text-red-500">*</span>
                </label>
                <input
                  type="number"
                  min="1"
                  value={formData.maturity_period}
                  onChange={(e) => handleChange('maturity_period', parseInt(e.target.value) || 1)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900"                />
              </div>
            </div>
          </div>
